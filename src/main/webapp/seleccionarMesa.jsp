<%-- 
    ...
    Created on : Oct 4, 2023, 11:29:15 PM
    Author     : Axel
--%>
...
<html>
    ...
    <body>
        ...
        <h3>aca deberiamos seleccionar la mesa y con ese dato, pasar al detalle de la orden</h3>
        <a href="nuevaOrden.jsp"><button type="button" class="btn btn-dark">Seleccionar Platos</button></a>
    </body>
</html>
