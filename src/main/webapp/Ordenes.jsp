<%-- 
    Document   : Ordenes
    Created on : Sep 25, 2023, 11:57:47 PM
    Author     : Axel
--%>
...
<html>
    ...
    <center>
        Aqui se ven las ordenes
        <br>
        <a href="nuevaOrden.jsp"><button type="button" class="btn btn-dark">Nueva Orden</button></a>
    </center>
    <table class="table table-bordered">
        <th>Codigo de Orden<th>Mesa<th>Empleado<th>Estado<th>
    </table>
</body>
</html>
