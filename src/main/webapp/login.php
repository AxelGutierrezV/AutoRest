...
<html>
    ...
    <body style="background-color: rgb(255, 227, 142); text-align: -webkit-center;
        ...
        <div style="background-color: white; width: 40%; align-content: center; padding: 50px 30px; border-radius: 21px; ">
            ...
            <input class="form-control" type="password" placeholder="contraseña" style="margin-bottom: 20px;">
            <a href="main.php"><button type="button" class="btn btn-danger btn-lg">Ingresar</button></a>
        </div>
    </body>
</html>
